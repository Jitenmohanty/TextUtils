...
export default function TextForms(props) {
  ...
  return (
    ...
    <div style={{color:props.mode  === 'dark'?'white':'black'}}>
      ...
      <button className="btn btn-danger mx-2" onClick={clearClick}>Clear all</button>
      <button className="btn btn-success mx-2" onClick={removeExtraSpace}>removeExtraSpace</button>
      <button className="btn btn-success mx-2" onClick={(e) => copyClick(text)}>Copy to Clipboard</button> 
